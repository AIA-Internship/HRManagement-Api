...
{
    // ── Projects ────────────────────────────────────────────────────
    Task<List<TimesheetProject>> GetAllProjectsAsync();
    Task<TimesheetProject?> GetProjectByIdAsync(int id);
    Task AddProjectAsync(TimesheetProject project);
    Task UpdateProjectAsync(TimesheetProject project);
    ...
    Task DeleteEntryAsync(TimesheetEntry entry);

    // ── Submissions ──────────────────────────────────────────────────
    Task<TimesheetSubmission?> GetSubmissionAsync(int employeeId, int year, int month);
    Task<TimesheetSubmission?> GetSubmissionByIdAsync(int submissionId);
    ...
    Task AddSubmissionAsync(TimesheetSubmission submission);
    Task UpdateSubmissionAsync(TimesheetSubmission submission);
    ...
    Task DeleteTodoTaskAsync(TodoTask task);
