...
/// </summary>
public class TimesheetSubmission : BaseTable
{
    ...
    public TimesheetSubmission(int employeeId, int year, int month, int actionerId)
    {
    ...
    public void Resubmit(int actionerId)
    {
    ...
    public void Approve(int supervisorId, int actionerId)
    {
        Status = 1;
    ...
    public void GiveRevision(int supervisorId, string revisionNote, int actionerId)
    {
        Status = 2;
