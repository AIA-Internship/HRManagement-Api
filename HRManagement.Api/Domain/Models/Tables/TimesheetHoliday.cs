...
namespace HRManagement.Api.Domain.Models.Tables
{
    ...
    /// </summary>
    public class TimesheetHoliday : BaseTableModel
    {
        ...
        public TimesheetHoliday(DateTime holidayDate, string name, string? description, long actionerId)
        {
        ...
        public void UpdateDetails(DateTime holidayDate, string name, string? description, long actionerId)
        {
            HolidayDate = holidayDate.Date;
            Name = name;
            Description = description;
