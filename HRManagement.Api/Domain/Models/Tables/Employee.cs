...
public class Employee : BaseTableModel
{
    ...
    public void UpdateEmploymentInfo(int? status, DateTime? startDate, int? type, string? department, string? position, int? supervisorId, string? supervisorName, string? employeeDisplayId, long actionerId)
    {
        if (EmploymentInformation == null)
        {
        ...
        EmploymentInformation.UpdateDetails(status, startDate, type, department, position, supervisorId, supervisorName, employeeDisplayId, actionerId);
